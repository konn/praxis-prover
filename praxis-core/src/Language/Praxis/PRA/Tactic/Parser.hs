...
name of a lemma stating an equation, @|- t = s@: its hypotheses, if it has
any, are discharged by the goal's where its instance is appealed to, and
its premises, if it has any, are left as goals after the step:
@cong zeroMinus@ finds the instance of @0 - t = 0@
