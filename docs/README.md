...
| [elaboration.md](elaboration.md) | how the surface language becomes core definitions and certified theorems: the encoding of data types, the compilation of functions, the generated lemmas, the translation of statements and proofs, and the invariants that keep it sound and fast |
